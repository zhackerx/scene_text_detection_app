...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int IMAGE_GALLERY_PICK_CODE=1000;
    private static final int IMAGE_CAMERA_PICK_CODE=1001;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1=(Button)findViewById(R.id.live);
